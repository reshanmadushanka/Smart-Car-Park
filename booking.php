...
$cal_cost = $difference * 300;//calculate cost
// get customer detail
...
<div class="row">
        <form method="post" action="booking.php"  class="col-lg-6 pull-left">
            ...
            <label class="text-white" for="date">Select Date</label>
                <input name="date" value="<?= $_POST['date'];?>" disabled class="form-control" type="text">
            </div>
            <div class="col-lg-12 pull-left">
            <label class="text-white" for="date">Select From Time</label>
                <input name="f_time" value="<?= $_POST['t_from'] ?>" class="form-control" type="text" disabled>
            </div>
            <div class="col-lg-12 pull-left">
            <label class="text-white" for="date">Select To Time</label>
                <input name="t_time" value="<?= $_POST['t_to'] ?>" class="form-control" type="text" disabled>
            </div>
            <div class="col-lg-12 pull-left">
            <label class="text-white" for="date">No Of Hourse</label>
                <input name="t_time" value="<?= $difference?>" class="form-control" type="text" disabled>
            </div>
            <div class="col-lg-12 pull-left">
            <label class="text-white" for="date">Price</label>
                <input name="t_time" value="<?= $cal_cost; ?>" class="form-control" type="text" disabled>
            </div>
